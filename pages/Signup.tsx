    ...
    return (
        <div className="relative min-h-screen bg-black flex items-center justify-center overflow-hidden p-6">
            ...
            <div className="relative z-10 w-full max-w-5xl grid lg:grid-cols-2 gap-8 items-center">
                ...
                {/* Left Column: Visuals/Branding (Hidden on mobile) */}
                <motion.div
                    className="hidden lg:flex flex-col justify-center space-y-8 p-12 order-2 lg:order-1"
                    initial="hidden"
                    animate="visible"
                    variants={fadeInUp}
                >
                    <div className="relative w-full aspect-square max-w-md mx-auto">
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center space-y-4">
                            <h1 className="font-display font-extrabold text-5xl tracking-tighter text-white">
                                JOIN THE <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-purple-600">REVOLUTION</span>
                            </h1>
                            <p className="text-blue-100/60 font-light text-lg">
                                Be part of the community building Pakistan's deeptech future.
                            </p>
                        </div>
                    </div>
                </motion.div>
                ...
                {/* Right Column: Form */}
                <motion.div
                    className="w-full max-w-md mx-auto bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl relative order-1 lg:order-2 hover:shadow-[0_0_40px_rgba(56,189,248,0.1)] hover:border-white/20 transition-all duration-300"
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2 group">
                            <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider ml-1 group-focus-within:text-sky-400 transition-colors">Full Name</label>
                            <div className="relative transform transition-all duration-200 group-focus-within:scale-[1.01]">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <User className="h-5 w-5 text-gray-500 group-focus-within:text-sky-400 transition-colors" />
                                </div>
                                <input
                                    type="text"
                                    value={name}
                        ...
                        <div className="space-y-2 group">
                            <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider ml-1 group-focus-within:text-sky-400 transition-colors">Confirm Password</label>
                            <div className="relative transform transition-all duration-200 group-focus-within:scale-[1.01]">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <Lock className="h-5 w-5 text-gray-500 group-focus-within:text-sky-400 transition-colors" />
                                </div>
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-[#0a0a0a] px-3 text-gray-500">Or sign up with</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 text-center text-sm text-gray-400">
                        ...
                        <Link to="/login" className="text-sky-400 hover:text-sky-300 font-medium hover:underline decoration-sky-400/30 underline-offset-4 transition-all">
                            Sign In
                        </Link>
                    </div>
                </motion.div>
